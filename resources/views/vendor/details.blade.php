            ...
            <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post-additional-info">
                            ...
                            <span class="category">
                                ...
                                <a href="{{ route('singleCategory_post', ['id'=>$post->category->id]) }}">{{ $post->category->name }}</a>
                            </span>
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="widget w-tags">
                                <div class="tags-wrap">
                                    ...
                                    <a href="{{ route('singleTag_post', ['id'=>$tag->id]) }}" class="w-tags-item">{!! $tag->tag !!}</a>
                                    @endforeach
                                </div>
                            </div>
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img style="width: 100px;" src="{{ asset($post->user->profile_photo_path) }}" alt="Author">
                    </div>
                ...
                <div class="pagination-arrow">
                    ...
                    @if($next_post)
                    <a href="{{ route('details_post', ['id'=>$next_post->id, 'slug'=>$next_post->slug]) }}" class="btn-prev-wrap">
                        <svg class="btn-prev">
                    ...
                    @if($previous_post)
                    <a href="{{ route('details_post', ['id'=>$previous_post->id, 'slug'=>$previous_post->slug]) }}" class="btn-next-wrap">
                        <div class="btn-content">
                ...
                <div class="comments">
                    ...
                    <div class="heading text-center">
                        ...
                        <!-- @include('vendor.includes.disqus') -->
                    </div>
                </div>
                ...
                <div class="comments">
                    ...
                    <div class="heading text-center">
                        <h4 class="h1 heading-title">Manually Comments</h4>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>
                        @include('vendor.includes.ManuallyComment')
                    </div>
                </div>
